...
#include "readutil_contact.h"
#include "contact_contact.h"
double CContact::SEPDIST;

using namespace std;

//
// arg 1 = centerpqrfile1 - chain 0 (in)
// arg 2 = centerpqrfile2 - chain 1 (in)
// arg 3 = atomcontactlist - expressed as index of apos1 and apos2 (in)
// arg 4 = atompqr1fname - chain 0 atom pqr file (in)
// arg 5 = atompqr2fname - chain 1 atom pqr file (in)
...
int mainFindContacts_fromAtomContactList(int argc, char ** argv)
{
  ...
  readpqrAtoms_old(atompqr1fname, apos1, duma, dumb);
  readpqrAtoms_old(atompqr2fname, apos2, duma, dumb);
  ...
  for(int h = 0; h < list0.size(); h++)
    {
      ...
      //      cout << "read contact pair "<<h<< " " <<a1<<" "<<a2<<endl;
      int kid1=-1, kid2=-1;
