...
public:
  ...
  static void xformHrotMono(const CSolExpCenter &source, const CSolExpCenter &target,CLocalExpan &Mout);
  static void xformHrotMonoG(const CSolExpCenter &source, const CSolExpCenter &target, CTriExpan &Mout);
  static void xformHrotMonoG(const CSolExpCenter &source, const CSolExpCenter &target, CTriExpan &Mout, double Q);
  static void xformGHrotMono(const CSolExpCenter &source, const CSolExpCenter &target, CTriExpan &Mout);
