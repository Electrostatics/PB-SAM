...
////////////////////////////////////////////////
// CSolExpCenter
// Expansion centers with 
// partially exposed surface
////////////////////////////////////////////////
/*#########################################################*/
/*#########################################################*/
...
public:
	...
	//  void addInterOverlapPolList( CFullSphereID c ) 
	//  {m_interOverlapPolList.push_back( c );}
	...
	//  const vector<CFullSphereID> & getInterOverlapPolList(  ) const 
	//  	{return m_interOverlapPolList;} 
...
private:
	...
	//  double solveFH( const vector<double> &LH, const vector<double>  &LF, 
	//  			int pm, int pn );
	...
	double m_constH1[N_POLES], m_constF1[N_POLES], 
	m_constH2[N_POLES], m_constF2[N_POLES], 
	m_constLH1[N_POLES], m_constLF1[N_POLES],
	m_constLH2[N_POLES], m_constLF2[N_POLES];
