...
/******************************************************************/
/**
 * CExpan initConstants for initializing constants of a basic
 expansion.
 ******************************************************************/
void
...
// for the expansion based on min and max
...
/*#########################################################*/
// Choose an appropriate scaling factor
// for the expansion based on the given
...
/*#########################################################*/
/*#########################################################*/
// Create an expansion using the
// supplied coefficients in the i-th row
...
/******************************************************************/
/**
 * Construct a multipole expansion for a set of charges, calls MExpan
 constructor
 ******************************************************************/
...
/******************************************************************/
/**
 * CSHExpan initConstants for initializing constants of a spherical
 harmonics expansion.  Also calls an initialization of the Expan object
 constants
 ******************************************************************/
void
...
/*#########################################################*/
/*#########################################################*/
// Computes the coefficients to the
...
/*#########################################################*/
/*#########################################################*/
// Special spherical harmonics that
// are used in singular cases.
/*#########################################################*/
/*#########################################################*/
...
/*#########################################################*/
/*#########################################################*/
// calculate the legendre polynomials for
// the new p-l layer ( to m_legendre )
...
CSHExpan::inc(  )
{
	...
	assert( p <= 2*N_POLES );
	setRange(  CRange(0, p, true ) ); // note that we need this format of
...
/*#########################################################*/
/*#########################################################*/
// Convert the spherical harmonics
// expansion to its derivative with respect
// to theta.
/*#########################################################*/
/*#########################################################*/
...
/*#########################################################*/
/*#########################################################*/
// Convert the spherical harmonics expansion
// to its derivative with respect
// to phi.
/*#########################################################*/
/*#########################################################*/
...
}	// end CSHExpan::derivPhi(  )

/******************************************************************/
/******************************************************************/
/**
 * CRExpan initConstants for initializing constants of a radial
 expansion.  Also calls an initialization of the SHExpan object
 constants
 ******************************************************************/
void
CRExpan::initConstants( REAL kappa )
{
	...
	KAPPA = kappa;
	for ( int n = 0; n < 2*N_POLES; n++ )
		CONST4[n] = 1.0/( ( 2*n-1 )*( 2*n-3 ) ); // 1.0/((2*n-1)*(2*n-3)), Used for besselK recursion EQ3 in Lotan 2006
}	 // end initConstants
...
CRExpan::operator=( const CRExpan & M )
{
	...
	return *this;
}// end CRExpan::operator=

/*#########################################################*/
/*#########################################################*/
// Apply the radial component of the expansion
...
/******************************************************************/
/**
 *  Initialize a multipole expansion for a single point charge
 ******************************************************************/
void
CMExpan::init(  )
{
...
/*#########################################################*/
/*#########################################################*/
// Generate the derivative of the expansion
...
/******************************************************************/
/**
 *  Initialize a Local expansion for a single point charge
 ******************************************************************/
void
CLExpan::init(  )
{
...
CLExpan::dMdr(  ) const
{
	...
	for ( int n = m_range.p1( ); n < m_range.p2(); n++)
	{
		REAL C = ir*( n - (m_bKappa ? (2*n+1 )*m_bessel[n+1]/m_bessel[n]
						   : 0.0 ));
