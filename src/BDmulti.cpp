...
#define WRITEFREQ 500				//!< how often we write restart data to a file
#define DISTCUTOFF_TIME 10	//!< The cutoff distance for interactions in angstroms
...
/******************************************************************/
/**
 * Initialize constants with cutoffs
...
/******************************************************************/
/**
 * Program to begin simulation from a given restart file
 ******************************************************************/
void
